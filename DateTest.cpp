...
#include <ctime>   //For handling the random seed using random time
...
int main()
{
	...
	DateType date1, date2;		//Two Date objects for testing
	...
	while ( inMenu )
	{
		cout<< endl << endl << endl;
		cout << "****************************************************" << endl;
		cout  <<"**  MENU:(Enter a character to select an option)  **" << endl;
 		cout << "****************************************************" << endl;
		...
		case 'S': case 's':
			cout << endl << endl 
				  << "******************************************************************" << endl
				  << "***   Test 1: Call date1, a Date object declared in the main function,"  << endl
		...
		case 'R': case 'r':
			cout << endl << endl 
				  ...
				  << "***		on two Date objects, date1 and date2 declared " << endl
		...
		case 'A': case 'a':
            ...
            date1.PrintDate();
			cout <<endl<< " Now after \"date2 = date1 - i;\" we have date2 as " <<endl;
			date2.PrintDate();
			...
			cout << endl<<" Now after \"date2 = date1 + i;\" we have date1 as " << endl;
			date1.PrintDate();
			cout << endl<<" Now after \"date2 = date1 + i;\" we have date2 as " << endl;
			date2.PrintDate();
